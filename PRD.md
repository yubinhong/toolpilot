...
- 技术负责人：`TBD`
- 创建/更新：`2026-08-20`
- 关联任务：`TASK-002`、`TASK-003`；当前实现包含 50 条研究快照并已发布静态草稿，不代表 PRD 已批准正式内容范围
...
本 PRD 是研究后的产品草案，不代表功能已经实现。`TASK-002` 已建立 50 条产品官网/研究来源分离的静态草稿目录，`TASK-003` 已增加链接检查、来源状态和编辑发布门槛，并发布到 `https://toolpilot.cc`；正式内容、来源和商业流程仍未批准。
...
- 新增/变更数据：当前工具条目包含名称、分类、草稿描述、适用场景、信号、产品官网 `productUrl`、研究来源 `sourceUrl`、研究快照日期、官网/来源链接检查、来源状态、编辑审核 Owner/状态/时间、商业状态、佣金备注和 `verifiedAt`；50 条均为 `Draft`，正式价格/限制、更新时间、事实核验、比较关系和商业关系模型仍为 `TBD`。
...
- [ ] 50 条目录完成产品事实、来源新鲜度、商业条款和独立评价审核；链接可达不等于事实核验。
